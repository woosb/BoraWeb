			...
			<form action="modify.do" method="post">
				<table class="table table-stripted" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048"style="height: 300px;"> <%=bbsDTO.getBbsContent()%> </textarea></td>
 						</tr>					
					</tbody>
				</table>
				<input type="submit" class="btn btn-primary pull-right" value="수정하기">
			</form>
				<a href="bbs_view.jsp" class="btn btn-primary pull-left">뒤로가기</a>			
		</div>
	</div>
